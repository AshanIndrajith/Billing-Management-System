...
public class DeleteBuyer extends javax.swing.JFrame {
    ...
    try {
        ...
        String query = "DELETE FROM buyer WHERE contactNo = '" + contactNo1 + "'";
        int rowsDeleted = st.executeUpdate(query);
        if (rowsDeleted > 0) {
            JOptionPane.showMessageDialog(null, "Data deleted successfully");
            // Clear the JTextFields after deletion if necessary
            name.setText("");
            contact1.setText("");
            email.setText("");
            address1.setText("");
            ...
            JOptionPane.showMessageDialog(null, "No record found for the provided contact number");
        }
